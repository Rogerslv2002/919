...
import Mar1 from '../components/Marquee/Mar1'
import Faq from '../components/Blocks/Faq'
export default function Home(){
    return(
        <>
                
          <section className=" z-10 w-full px-5 pt-32 lg:px-10 lg:pt-40 pb-20 flex flex-col gap-8 place-items-center">
        ...
        <section className=' border-lime-300 bg-gradient-to-r from-lime-300 to-emerald-300 backdrop-blur-lg flex  place-self-center  border-b-2 border-t-2 py-5 w-full'>
          <Mar1/>
        </section>
        ...
        <section className=' py-5 border-lime-300 bg-gradient-to-r from-lime-300 to-emerald-300 backdrop-blur-lg flex  place-self-center  border-b-2 border-t-2  w-full'>
          
          <Mar1/>
        </section>
        <section className=" w-full px-20 py-10 flex flex-col gap-10">
          <h2 className=' text-white text-center text-5xl font-semibold'>Perguntas Frequentes  </h2>
  ...
  />
        ...
        <section className=" px-5 lg:px-20 py-10 flex flex-col gap-8">
            ...
            <div className=" flex flex-col-reverse lg:flex-row gap-10">
                <div className=" w-full lg:w-1/2 flex flex-col gap-10 lg:gap-3 ">
